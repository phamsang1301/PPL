...
index_exp: exp7 list_key | exp7;

key: LSB list_exp RSB;
list_key: key list_key | key; 

exp7: func_call | operands;

operands: literal | ID | LP exp RP;
func_call: CALL LP ID CM LSB list_exp RSB RP
          | CALL LP ID CM LSB RSB RP;
